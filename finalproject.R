...
## an alternative way to summarise the DataFrame is the use of dcast function, This will create a wide dataFrame

castDF <- tbl_df(dcast(moltenDF,  subjects + activity ~ feature + signal+ angle, mean))

## to get the output of summarise_all, a melt function would create a similar narrow table
